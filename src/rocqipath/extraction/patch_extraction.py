...
Original, fixed-naming API::
    ...
    from rocqipath.extraction.patch_extraction import ReversiblePatchExtractor
...
Current, config-driven API::
    ...
    from rocqipath.extraction.patch_extraction import PatchExtractionConfig, run_patch_extraction
