...
from rocqipath._internal.geometry import (
    add_scale_bar as _add_scale_bar_impl,
    region_bbox as _region_bbox_impl,
    region_tissue_fraction as _tissue_fraction_impl,
)
from rocqipath.viz.figure_helpers import (
    _save_annotated_full_view,
    _save_plot,
)
from rocqipath.viz.roi import (
    _ROI_COLORS,
    _ROI_SIDECAR_SUFFIX,
