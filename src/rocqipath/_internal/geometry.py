...
from rocqipath.tissue.masks import pil_brightness_saturation_fraction
...
def region_tissue_fraction(image: Any, bbox: tuple[int, int, int, int]) -> float:
...
def region_bbox(
    ...
    image: Any | None = None,
    *,
    tissue_fraction_fn: Callable[[Any, tuple[int, int, int, int]], float] = region_tissue_fraction,
